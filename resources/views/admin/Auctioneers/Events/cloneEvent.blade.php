...
@section('page-header')
    <span class="text-semibold">Event</span> - Create a new event from a clone
@stop
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title">
                            <a href="#accordion-control-right-group1" data-parent="#accordion-control-right" data-toggle="collapse">{{$dealer->name}} : Cloned Event Details</a>
                        </h6>
                    </div>
                    <div class="panel-collapse collapse in" id="accordion-control-right-group1">
                        <div class="panel-body">
                            {!! Form::model($event, array('method' => 'POST', 'url' => '/admin/dealers/auctioneer/'.$dealer->slug.'/event/create')) !!}

                            @include('admin.Auctioneers.Events.partials.ReminderForm')
                            @include('admin.Auctioneers.Events.partials.CurrentDates')
