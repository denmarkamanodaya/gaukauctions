...
@section('content')
    ...
    <div class="col-md-4">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Edit A Feature</div>
                <div class="panel-body">

                    {!! Form::model($feature, array('method' => 'POST', 'url' => '/admin/dealers/features/'.$feature->slug, 'class' => 'form-horizontal', 'id' => 'feature-update', 'autocomplete' => 'off')) !!}
                    @include('admin.Auctioneers.Features.Features-Form')
                    <div class="form-group">
                        <div class="col-lg-6">
                            {!! Form::button('<i class="far fa-save"></i> Edit Feature', array('type' => 'submit', 'class' => 'btn btn-primary')) !!}
                            {!! Form::close() !!}
                        </div>
                        <div class="col-lg-6">
                            {!! Form::open(array('method' => 'POST', 'url' => '/admin/dealers/features/'.$feature->slug.'/delete', 'class' => 'form-horizontal', 'id' => 'feature-delete', 'autocomplete' => 'off')) !!}
                            {!! Form::button('<i class="far fa-times"></i> Delete Feature', array('type' => 'submit', 'class' => 'btn btn-danger')) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
