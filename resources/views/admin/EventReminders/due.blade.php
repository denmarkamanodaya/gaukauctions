        ...
        $('.confirmDelete').on('click', function() {
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        window.location = '{{url('admin/dealers/eventReminders')}}/due/' + id + '/delete';
                    }
                }
            });
        });
...
@section('page-header')
    <span class="text-semibold">Reminders</span> - Due Event Reminders
@stop
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    &nbsp;&nbsp;
                    {!! Form::open(array('method' => 'POST', 'url' => '/admin/dealers/eventReminders/due/deleteSelected')) !!}
