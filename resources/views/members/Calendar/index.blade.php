...
@section('breadcrumbs')
    {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'),'Auction Calendar' => 'is_current']) !!}
@stop
...
@section('content')
    ...
    @endif
            ...
            <div class="row" style="">
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 mb-20" style="margin-left: 8.66666667%">
