<div class="eventDate text-center">{{$eventDate}}</div>
    <div class="panel panel-default eventPanel">
        <div class="panel-heading" role="tab" id="heading-{{$event->slug}}">
            <h4 class="panel-title">
                ...
                <div class="col-md-10 eventTitle">
                    {{$event->title}}
                </div>
        ...
        <div>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-1"><i class="far fa-bars fa-2x eventBars"></i></div>
                ...
                <div class="row mt-20">
                    ...
                    <?php
                    if(isset($dealer->longitude) && $dealer->longitude != '' && isset($dealer->latitude) && $dealer->latitude != '')
                        {
                            $mapNum = 2;
                        } else $mapNum = 0;
                    ?>
                    ...
                    @if($event->meta->latitude && $event->meta->latitude != '')
                        <div class="eventMapContainer"><div id="map_{{$event->id}}" style="width: 100%; height: 150px;">
                                {!! Mapper::render($mapNum) !!}
                            </div></div>
                    @endif
