...
@section('breadcrumbs')
    {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'), 'Auctioneers' => '/members/auctioneers', $dealer->name => '/members/auctioneer/'.$dealer->slug, 'Report A Problem' => 'is_current']) !!}
@stop
                ...
                <div class="section-fullwidth col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            ...
                            {!! Form::open(array('method' => 'POST', 'url' => '/members/auctioneer/'.$dealer->slug.'/report-a-problem', 'autocomplete' => 'off')) !!}

                                <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::textarea('about', null, array('class' => 'form-control', 'id' => 'about', 'placeholder' => 'Describe the issue here')) !!}
                                ...
                                <div class="col-md-4">
                                <div class="form-group">
                                    {!! Form::button('<i class="far fa-exclamation-triangle"></i> Report A Problem', array('type' => 'submit', 'class' => 'btn btn-gauk')) !!}
                                    {!! Form::close() !!}
                                </div>
                                </div>
