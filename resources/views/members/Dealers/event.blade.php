...
@section('page_css')
    <link href="http://gauk.test/assets/css/gaukDailyEvent.css" rel="stylesheet" type="text/css">
@stop

@section('breadcrumbs')
    {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'), 'Auctioneers' => '/members/auctioneers', $dealer->name => '/members/auctioneer/'.$dealer->slug, 'View Event' => 'is_current']) !!}
@stop
                ...
                <div class="section-fullwidth col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            ...
                            @include('members.Dealers.partials.eventDetails')
