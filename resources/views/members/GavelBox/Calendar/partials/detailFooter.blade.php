    ...
    @if($event->cal_eventable instanceof App\Models\Dealers)
        <div class="row">
            ...
            <div class="col-md-11">
                ...
                <div class="col-lg-6"><i class="far fa-gavel mr-5"></i> <a target="_blank" href="{{url('/members/auctioneer/'.$event->cal_eventable->slug)}}">View {{$event->cal_eventable->name}}</a></div>
                <div class="col-md-6">
