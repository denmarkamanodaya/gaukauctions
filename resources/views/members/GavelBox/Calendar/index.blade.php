...
@section('page_js')
    <script>
        var eventsUrl = '/members/gavelbox/calendar/getDaysEvents';
...
@section('breadcrumbs')
    {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'), 'GavelBox' => '/members/gavelbox', 'Auction Calendar' => 'is_current']) !!}
@stop
