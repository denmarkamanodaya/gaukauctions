...
@section('pre-content')
    <div class="page-section page-intro"><img class="img-responsive=" src="http://gaukmotors.co.uk/media/11-17/photos/Gauk/Motorpedia_About-hero.jpg" /></div>
@stop
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 post-body">@if($post->meta->featured_image)<div class="post_list_image"><img src="{{ url($post->meta->featured_image) }}"></div> @endif{!! $post->content !!}</div>
