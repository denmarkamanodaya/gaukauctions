...
@section('breadcrumbs')
    ...
    @else
        {!! breadcrumbs([Settings::get('members_home_page_title') => Settings::get('members_home_page'), 'Blog' => 'is_current']) !!}
    @endif
@stop
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="cs-media">
                            @if($post->meta->featured_image)
                                <figure>
                                    <a href="{!! postLink($post, 'members') !!}"><img class="img-responsive" alt="" src="{{ url($post->meta->featured_image) }}"></a>
                                </figure>
                            @endif
                        </div>
                        <div class="cs-text">
