...
@section('breadcrumbs')
    {!! breadcrumbs(['Home' => '/', 'Auctioneers' => 'is_current']) !!}
@stop
...
@section('content')
            ...
            <div class="dealer-listing-wrap">
                <div class="mt-20 mb-20">@include('frontend.NeedRegister.horizontalBannerUpgrade')</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="auto-your-search text-center">
                        ...
                        <a class="clear-tags cs-color" href="{!! url('/auctioneers/clearFilters') !!}">Clear Filters</a>
                    </div>
                </div>
                <hr style="margin-top: -20px"/>
                    ...
                    @foreach($dealers as $dealer)
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            @include('frontend.Dealers.partials.dealerCard')
                        </div>
                    @endforeach
