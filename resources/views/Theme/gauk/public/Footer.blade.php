                    ...
                    <div class="widget widget-our-partners">
                        <div class="widget-section-title">
                            <p style="text-align:center">
                                <a href="{!! url('/register') !!}"><img class="img-responsive" alt="Register at gauk auctions uk" height="120" src="{!! url('/images/Register-Footer-auctions.jpg') !!}" width="550" /></a>
                            <h6 style="color:#fff !important">GAUK AUCTIONS, NATIONAL AUCTION SEARCH</h6>
                        </div>
                        <p>Search everything available at auction across the UK <br>TRADERS: If you're a Trader and already 'in the know' regarding all the great deals to be found at auctions and simply want the facility to search all the events and lots available on a weekly basis then simply Register <a href="http://gaukauctions.com/register">HERE</a> to search auctions<br>

                            EVERYBODY ELSE: If you're in the market for just about anything and don't want to pay FULL RETAIL PRICE Register <a href="http://gaukauctions.com/register">HERE</a></p>
                    </div>
                </div>
