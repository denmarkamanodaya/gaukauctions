...
<head>
    ...
    {!! Twitter::generate() !!}
    @yield('meta')
    <link rel="shortcut icon" href="{!! url('/images/AuctionsFavicon.ico') !!}" type="image/x-icon" />
...
smartlook('init', '1c6a88935b72add8e4485c950ca3205222b94981');
</script>
