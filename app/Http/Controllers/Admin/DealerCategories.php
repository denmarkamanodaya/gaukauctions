...
use App\Http\Requests\Admin\createCategoryChildRequest;
...
class DealerCategories extends Controller
{
    ...
    {
        $category = $this->categoryService->getAdminCategoryBySlug($id);
    ...
    {
        $category = $this->categoryService->getAdminCategoryBySlug($parent_id);
        $childCategories = $this->categoryService->getChildCategories($category->id);
