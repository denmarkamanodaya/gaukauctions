...
(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        if (jQuery(".garageSideMenu>li").length != '') {
            var secondMenu = $('.garageSideMenu').clone();
            secondMenu.children('li').appendTo(combinedMenu);
        }
        if (jQuery(".cs-user-dropdown>ul").length != '') {
            var userMenu = $('.cs-user-dropdown').clone();
            userMenu.children('a').appendTo(combinedMenu);
        }
    ...
    jQuery(window).load(function() {
        if (jQuery(".cs-select-model .cs-checkbox-list2").length != '') {
